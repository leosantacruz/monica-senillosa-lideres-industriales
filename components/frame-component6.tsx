          ...
          <div className={styles.frameGroup}>
            <div className={styles.frameDiv}>
              ...
              <div className={styles.nuestroProgramaIncrementa}>
                Nuestro programa incrementa la rentabilidad de su empresa a
                través de la optimización de procesos y resultados. Aquí algunos
                de los beneficios que podrá obtener:
              </div>
            </div>
